...
/*
 * Class:     sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser
 * Method:    init0
 * Signature: ()V
 */
extern "C"
JNIEXPORT void JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_init0
  (JNIEnv *env, jclass this_cls) {
  jclass cls = env->FindClass("sun/jvm/hotspot/debugger/bsd/amd64/DwarfParser");
  CHECK_EXCEPTION
 ...
 */
extern "C"
JNIEXPORT jlong JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_createDwarfContext
 ...
 */
extern "C"
JNIEXPORT void JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_destroyDwarfContext
 ...
 */
extern "C"
JNIEXPORT jboolean JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_isIn0
 ...
 */
extern "C"
JNIEXPORT void JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_processDwarf0
  (JNIEnv *env, jobject this_obj, jlong pc) {
  DwarfParser *parser = reinterpret_cast<DwarfParser *>(get_dwarf_context(env, this_obj));
 ...
 */
extern "C"
JNIEXPORT jint JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_getCFARegister
 ...
 */
extern "C"
JNIEXPORT jint JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_getCFAOffset
  (JNIEnv *env, jobject this_obj) {
  DwarfParser *parser = reinterpret_cast<DwarfParser *>(get_dwarf_context(env, this_obj));
 ...
 */
extern "C"
JNIEXPORT jint JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_getReturnAddressOffsetFromCFA
  (JNIEnv *env, jobject this_obj) {
  DwarfParser *parser = reinterpret_cast<DwarfParser *>(get_dwarf_context(env, this_obj));
 ...
 */
extern "C"
JNIEXPORT jint JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_getBasePointerOffsetFromCFA
  (JNIEnv *env, jobject this_obj) {
  DwarfParser *parser = reinterpret_cast<DwarfParser *>(get_dwarf_context(env, this_obj));
 ...
 */
extern "C"
JNIEXPORT jboolean JNICALL Java_sun_jvm_hotspot_debugger_bsd_amd64_DwarfParser_isBPOffsetAvailable
  (JNIEnv *env, jobject this_obj) {
  DwarfParser *parser = reinterpret_cast<DwarfParser *>(get_dwarf_context(env, this_obj));
